classdef VSO < DataSource
    ...
    properties
        ...
        wavl;       % Cell array of wavelengths for observation
    ...
    methods
        ...
        function fits_files = query_and_get(S)
            ...
            num_wavl = numel(S.wavl);
            
            fits_files = {};
            
            % Loop through each wavelength
            for i = 1:numel(S.wavl)
                
                % Create arguments for query
                kwargs = pyargs('instrument', S.inst_name, 'min_wave', S.wavl{i}, 'max_wave', S.wavl{i}, 'unit_wave', S.unit_wav);
